...
export default function BlogPage() {
  return (
    <div className="min-h-screen bg-[#222831] flex flex-col">
      ...
      {/* --- FOOTER --- */}
      <footer className="mt-auto bg-[#1A1F26] border-t border-[#00ADB5]/10 p-12 text-center">
        <p className="text-[#EEEEEE]/20 text-[10px] uppercase tracking-[0.3em]">
          © 2026 FITTRACK • NO EXCUSES
        </p>
      </footer>
    </div>
  );
