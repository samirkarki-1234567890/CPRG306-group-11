    ...
    <div className="min-h-screen bg-[#222831] flex flex-col">
      ...
      <nav className="w-full py-5 px-8 flex justify-between items-center bg-[#393E46]/50 backdrop-blur-md sticky top-0 z-50 border-b border-[#00ADB5]/20">
        ...
        <div className="hidden md:flex space-x-8 items-center">
          <Link href="/features" className="text-[#EEEEEE]/70 hover:text-[#00ADB5] transition-colors font-medium">Features</Link>
          <Link href="/pricing" className="text-[#EEEEEE]/70 hover:text-[#00ADB5] transition-colors font-medium">Pricing</Link>
          <Link href="/community" className="text-[#EEEEEE]/70 hover:text-[#00ADB5] transition-colors font-medium">Community</Link>
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6">
        <div className="bg-[#393E46] p-12 rounded-2xl shadow-2xl text-center max-w-3xl border-b-4 border-[#00ADB5]">
          ...
          <p className="text-lg md:text-xl mb-10 text-[#EEEEEE]/80 font-light max-w-md mx-auto leading-relaxed">
            Level up your training. Track <span className="text-[#00ADB5] font-bold">workouts</span>, 
            manage <span className="text-[#00ADB5] font-bold">nutrition</span>, and crush your goals.
          </p>
